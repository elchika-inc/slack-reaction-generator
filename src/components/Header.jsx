function Header() {
  return (
    <header className="bg-white shadow-sm border-b border-gray-200 sticky top-0 z-40" style={{minHeight: '64px'}} role="banner">
      <div className="container mx-auto px-3 lg:px-4 py-3 lg:py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2 lg:space-x-3">
            ...
            <div>
              <h1 className="text-lg lg:text-2xl font-bold text-gray-900" style={{lineHeight: '1.2'}}>
                Slack Reaction Generator
              </h1>
              <p className="text-xs lg:text-sm text-gray-700 hidden lg:block" style={{lineHeight: '1.2'}}>
                カスタムリアクション絵文字を簡単作成
              </p>
            </div>
          </div>
          <nav className="flex items-center" role="navigation" aria-label="外部リンク">
            <a
